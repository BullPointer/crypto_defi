...
const Borrow = () => {
  ...
  return (
    <div className="">
      <TransactionHeader
        header={"Borrow"}
        subheader={`At Osifi, we believe in the power of dreams and the 
        magic of possibilities. Our crypto loan services are designed to 
        help you unlock new opportunities without selling your assets. 
        Need funds for a new venture, education, or personal growth? Borrow in 
        with flexible terms and competitive interest rates. Our seamless 
        application process ensures you get the support you need, fast. Dare 
        to dream big, and let Osifi turn your aspirations into reality with 
        our innovative loan solutions.`}
      />
