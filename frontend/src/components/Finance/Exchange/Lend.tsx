...
import LendTransaction from "./components/LendTransaction";
...
const Lend = () => {
  ...
  return (
    <div className="">
      <TransactionHeader
        header={"Borrow"}
        subheader={`Looking for a way to make your money work for you? 
        Osifi's lending program is your ticket to financial growth. Lend your 
        assets to us and earn attractive returns while enjoying peace of mind. 
        Our secure platform ensures your investments are safe and productive. 
        Whether from Cryptocurrency or Fiat Currency, we provide an easy and 
        rewarding lending experience. Join our community of smart investors 
        and see your crypto portfolio soar. With Osifi, lending is not just an 
        option - it's a path to prosperity.`}
      />
