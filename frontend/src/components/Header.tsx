...
const Header = () => {
  return (
    <div>
      <div className="text-center sm:p-10 md:w-[80%] mx-auto">
        <header
        ...
        <section className="font-grotesk leading-8 px-8 text-[1.2rem] md:text-[1.0rem]">
          ...
          effortlessly. Repay at your own pace—no monthly payments, no extra
          fees. Whether you're a newbie or a pro, our user-friendly crypto
          lending and earning platform makes managing your digital assets fun
          and simple.
        </section>
